...
const ExcellentService = () => {
  return (
    <section id='aboutus'  className='flex flex-col sm:flex sm:flex-col lg:flex lg:flex-row bg-white justify-center items-center gap:12 lg:gap-20 pt-36  pb-36'>
        <MotionDiv initial={{x:-400}}  transition={{
  ease: "linear",
  duration: 1,
...
<MotionDiv transition={{
  ease: "linear",
  duration: 2,
}}
 initial={{opacity:0}} whileInView={{opacity:1}}  className={`${lora.className}  text-custom font-medium font-sans color-[#000]`}>Experience Tranquil Luxury in the Heart of Mount Abu, Rajasthan</MotionDiv>
<MotionDiv transition={{
  ease: "linear",
  duration: 2,
}}
 initial={{opacity:0}} whileInView={{opacity:1}} className='mt-5 text-justify text-base font-normal color-[#000]'> Welcome to Hotel Swagat, where peace and luxury combine in Mount Abu. Our retreat in the Aravalli Range offers an unforgettable stay. Discover the beauty of Rajasthan right outside our doors. Enjoy comfort and tranquility amidst stunning scenery. Your journey to relaxation begins here.</MotionDiv>
        <MotionDiv transition={{
  ease: "linear",
  duration: 2,
}}
 initial={{opacity:0}} whileInView={{opacity:1}} className='mt-2 text-justify text-base font-normal color-[#000]'> Indulge in the comforts of our accommodations, surrounded by breathtaking views. Let the peaceful ambiance of our surroundings soothe your soul. At Hotel Swagat, every moment is a sanctuary of relaxation and rejuvenation. Join us and discover the true essence of tranquility amidst the natural splendor of Mount Abu. Your unforgettable getaway awaits, where luxury meets serenity. Welcome to your home away from home.</MotionDiv>
