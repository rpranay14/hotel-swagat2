...
const RoomPage = () => {
    return (
        <section  className='  px-2 flex flex-col lg:flex-col xl:flex-row bg-white justify-center items-center xl:gap-8 2xl:gap:8 pt-36  pb-36'>
    ...
    <h1  className={`${lora.className}  text-x2l lg:text-custom font-medium font-sans color-[#000]`}>The best room just for you!</h1>
    <p className='mt-5 text-justify text-base font-normal color-[#000]'>Unlock unparalleled luxury and comfort with our premium accommodations at Hotel Swagat, Mount Abu. Our meticulously designed rooms offer a harmonious blend of elegance and modernity, providing the perfect retreat for discerning travelers. Indulge in stunning views of the Aravalli Range from the comfort of your room, and experience unmatched hospitality with our attentive staff. Book now and elevate your stay to new heights of relaxation and sophistication at Hotel Swagat, your ultimate destination in Mount Abu.ere.</p>
            ...
            <div className='flex flex-wrap md:w-[80%] w-[90%] lg:w-[60%] xl:w-[65%] 2xl:w-[55%]  gap-6 justify-center'>
                <Image  src={FIRST} className='mt-12 xl:mt-0 w-[100%] h-[300px] md:h-[400px] lg:w-[100%] lg:h-[400px] xl:w-[350px] 2xl:w-[400px] rounded-md xl:h-[250px]' />
                <Image src={SECOND} className='mt-12 xl:mt-0 w-[100%] h-[300px] md:h-[400px] lg:w-[100%] lg:h-[400px] xl:w-[350px] 2xl:w-[400px] rounded-md xl:h-[250px]' />
                <Image src={THIRD} className='mt-12 xl:mt-0 w-[100%] h-[300px] md:h-[400px] lg:w-[100%] lg:h-[400px] xl:w-[350px] 2xl:w-[400px] rounded-md xl:h-[250px]' />
                <Image src={FOURTH} className='mt-12 xl:mt-0 w-[100%] h-[300px] md:h-[400px] lg:w-[100%] lg:h-[400px] xl:w-[350px] 2xl:w-[400px] rounded-md xl:h-[250px]'  />
            </div>
        </section>
      )
}
